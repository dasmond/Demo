...
namespace DsLib.Common
{
    ...
    /// </summary>
    public class JsonObject : Newtonsoft.Json.Linq.JObject
    {
    ...
    public static class JsonHelper
    {
        ...
        /// <returns></returns>
        public static JsonObject DeserializeObject(string _json)
        {
            return JsonConvert.DeserializeObject(_json) as JsonObject;   
        }
        #endregion
