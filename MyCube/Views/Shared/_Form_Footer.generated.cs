...
WriteAttribute("class", Tuple.Create(" class=\"", 1322), Tuple.Create("\"", 1371)
, Tuple.Create(Tuple.Create("", 1330), Tuple.Create("control-label", 1330), true)
, Tuple.Create(Tuple.Create(" ", 1343), Tuple.Create("col-xs-", 1344), true)
            
            #line 33 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 1351), Tuple.Create<System.Object, System.Int32>(label
            
            #line default
            #line hidden
, 1351), false)
, Tuple.Create(Tuple.Create(" ", 1357), Tuple.Create("col-sm-", 1358), true)
            
            #line 33 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 1365), Tuple.Create<System.Object, System.Int32>(label
...
WriteAttribute("class", Tuple.Create(" class=\"", 1397), Tuple.Create("\"", 1456)
, Tuple.Create(Tuple.Create("", 1405), Tuple.Create("control-label", 1405), true)
, Tuple.Create(Tuple.Create(" ", 1418), Tuple.Create("col-xs-", 1419), true)
            
            #line 34 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 1426), Tuple.Create<System.Object, System.Int32>(total - label
            
            #line default
            #line hidden
, 1426), false)
, Tuple.Create(Tuple.Create(" ", 1442), Tuple.Create("col-sm-", 1443), true)
            
            #line 34 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 1450), Tuple.Create<System.Object, System.Int32>(input
...
WriteAttribute("title", Tuple.Create(" title=\"", 1621), Tuple.Create("\"", 1633)
            
            #line 38 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 1629), Tuple.Create<System.Object, System.Int32>(val
...
WriteAttribute("class", Tuple.Create(" class=\"", 2327), Tuple.Create("\"", 2376)
, Tuple.Create(Tuple.Create("", 2335), Tuple.Create("control-label", 2335), true)
, Tuple.Create(Tuple.Create(" ", 2348), Tuple.Create("col-xs-", 2349), true)
            
            #line 58 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 2356), Tuple.Create<System.Object, System.Int32>(label
            
            #line default
            #line hidden
, 2356), false)
, Tuple.Create(Tuple.Create(" ", 2362), Tuple.Create("col-sm-", 2363), true)
            
            #line 58 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 2370), Tuple.Create<System.Object, System.Int32>(label
...
WriteAttribute("class", Tuple.Create(" class=\"", 2402), Tuple.Create("\"", 2461)
, Tuple.Create(Tuple.Create("", 2410), Tuple.Create("control-label", 2410), true)
, Tuple.Create(Tuple.Create(" ", 2423), Tuple.Create("col-xs-", 2424), true)
            
            #line 59 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 2431), Tuple.Create<System.Object, System.Int32>(total - label
            
            #line default
            #line hidden
, 2431), false)
, Tuple.Create(Tuple.Create(" ", 2447), Tuple.Create("col-sm-", 2448), true)
            
            #line 59 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 2455), Tuple.Create<System.Object, System.Int32>(input
...
WriteAttribute("title", Tuple.Create(" title=\"", 2626), Tuple.Create("\"", 2638)
            
            #line 63 "..\..\Views\Shared\_Form_Footer.cshtml"
, Tuple.Create(Tuple.Create("", 2634), Tuple.Create<System.Object, System.Int32>(val
