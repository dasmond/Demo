...
namespace DsLib.Common
{
    ...
    public static class StringHelper
    {
        ...
        #region - Boolean EqualIgnoreCase(this String value, params String[] strs) -
        /// <summary>
        /// 字符串扩展：忽略大小写的字符串相等比较，判断是否以任意一个待比较字符串相等
        /// </summary>
        ...
        #region - Boolean StartsWithIgnoreCase(this String value, params String[] strs) -
        /// <summary>
        /// 字符串扩展：忽略大小写的字符串开始比较，判断是否以任意一个待比较字符串开始
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        #region - Boolean EndsWithIgnoreCase(this String value, params String[] strs) -
        /// <summary>
        /// 字符串扩展：忽略大小写的字符串结束比较，判断是否以任意一个待比较字符串结束
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        #region - Boolean IsNullOrEmpty(this String value) { return value == null || value.Length <= 0; } -
        /// <summary>
        /// 字符串扩展：指示指定的字符串是 null 还是 String.Empty 字符串
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        //字符串扩展：是否空或者空白字符串
        #region - Boolean IsNullOrWhiteSpace(this String value) -
        /// <summary>
        /// 字符串扩展：是否空或者空白字符串
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        #region - String[] Split(this String value, params String[] separators) -
        /// <summary>
        /// 字符串扩展：拆分字符串，过滤空格，无效时返回空数组
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        #region - Int32[] SplitAsInt(this String value, params String[] separators) -
        /// <summary>
        /// 字符串扩展：拆分字符串成为整型数组，默认逗号分号分隔，无效时返回空数组
        /// </summary>
        ...
        #region - IDictionary<String, String> SplitAsDictionary(this String value, String nameValueSeparator = "=", params String[] separators) -
        /// <summary>
        /// 字符串扩展：拆分字符串成为名值字典。逗号分号分组，等号分隔
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        #region - String Join(this IEnumerable value, String separator = ",") -
        /// <summary>
        /// 字符串扩展：把一个列表组合成为一个字符串，默认逗号分隔
        /// </summary>
        ...
        //字符串扩展：把一个列表组合成为一个字符串，默认逗号分隔
        #region - String Join<T>(this IEnumerable<T> value, String separator = ",", Func<T, String> func = null) -
        /// <summary>
        /// 字符串扩展：把一个列表组合成为一个字符串，默认逗号分隔
        /// </summary>
        /// <param name="value"></param>
        ...
        #region - StringBuilder Separate(this StringBuilder sb, String separator) -
        /// <summary>
        /// 字符串扩展：追加分隔符字符串，忽略开头，常用于拼接
        /// </summary>
        ...
        //字符串扩展：字符串转数组
        #region - Byte[] GetBytes(this String value, Encoding encoding = null) -
        /// <summary>
        /// 字符串扩展：字符串转数组
        /// </summary>
        /// <param name="value">字符串</param>
        ...
        //截取扩展：确保字符串以指定的另一字符串开始，不区分大小写
        #region - String EnsureStart(this String str, String start) -
        /// <summary>
        ...
        //截取扩展：确保字符串以指定的另一字符串结束，不区分大小写
        #region - String EnsureEnd(this String str, String end) -
        /// <summary>
        ...
        #region - String TrimStart(this String str, params String[] starts) -
        /// <summary>
        /// 截取扩展：从当前字符串开头移除另一字符串，不区分大小写，循环多次匹配前缀
        /// </summary>
        ...
        public static String TrimStart(this String str, params String[] starts)
        {
            if (String.IsNullOrEmpty(str))
                return str;
            if (starts == null || starts.Length < 1 || String.IsNullOrEmpty(starts[0]))
                return str;
        ...
        #region - String TrimEnd(this String str, params String[] ends) -
        /// <summary>
        /// 截取扩展：从当前字符串结尾移除另一字符串，不区分大小写，循环多次匹配后缀
        /// </summary>
        /// <param name="str">当前字符串</param>
        ...
        #region - String Substring(this String str, String after, String before = null, Int32 startIndex = 0, Int32[] positions = null) -
        /// <summary>
        /// 截取扩展：从字符串中检索子字符串，在指定头部字符串之后，指定尾部字符串之前
        ...
        #region - String Cut(this String str, Int32 maxLength, String pad = null) -
        /// <summary>
        /// 截取扩展：根据最大长度截取字符串，并允许以指定空白填充末尾
        /// </summary>
        /// <param name="str">字符串</param>
        ...
        #region - String CutBinary(this String str, Int32 maxLength, String pad = null, Boolean strict = true) -
        /// <summary>
        /// 截取扩展：根据最大长度截取字符串（二进制计算长度），并允许以指定空白填充末尾
        ...
        #region - String CutStart(this String str, params String[] starts) -
        /// <summary>
        /// 截取扩展：从当前字符串开头移除另一字符串以及之前的部分
        /// </summary>
        /// <param name="str">当前字符串</param>
        ...
        #region - String CutEnd(this String str, params String[] ends) -
        /// <summary>
        /// 截取扩展：从当前字符串结尾移除另一字符串以及之后的部分
        /// </summary>
        /// <param name="str">当前字符串</param>
        ...
        //LD编辑距离算法：编辑距离搜索匹配项
        #region - String[] LevenshteinSearch(String key, String[] words) - 
        /// <summary>
        ...
        //LCS算法：最长公共子序列搜索
        #region - String[] LCSSearch(String key, String[] words) -  
        /// <summary>
        ...
        static void Init()
        {
            if (_provider == null)
            {
                _provider = new System.Speech.Synthesis.SpeechSynthesizer();
